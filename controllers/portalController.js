...
exports.postUpdateProfile = async (req, res) => {
    ...
    try {
        ...
        if (parent_phone_alt !== undefined) req.session.student.parent_phone_alt = parent_phone_alt;
        if (parent_email !== undefined) req.session.student.parent_email = parent_email;
